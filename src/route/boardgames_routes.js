...
const {getBoardGames, getBoardGame, getAllBoardagmesValorations, getBoardgameValorations, postBoardgame, postValorationBoardgame, putBoardgame, deleteBoardgame}= require('../controller/boardagmes_controller.js');
